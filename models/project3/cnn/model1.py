...
from constants2 import CHECKPOINT_FILEPATH, DATA_PATH, VALIDATION_TEST_PATH
from model_architectures import create_model_project3_cnn_10x10
...
model = create_model_project3_cnn_10x10()
model.summary()
