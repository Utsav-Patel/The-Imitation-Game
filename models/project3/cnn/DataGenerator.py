...
from helpers.Agent6helper import pre_process_input
from constants2 import TRAINED_MODEL_NUM_COLS, TRAINED_MODEL_NUM_ROWS
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        final_x = list()
        for dct in X:
            final_x.append(pre_process_input(dct['input'], dct['current_pos'], project_no=3, architecture_type='cnn'))
